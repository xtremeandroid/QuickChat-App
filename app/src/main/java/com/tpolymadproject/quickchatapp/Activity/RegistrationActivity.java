...
import com.tpolymadproject.quickchatapp.ModelClass.Users;
        ...
        btn_SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(email) ||
                    ...
                    Toast.makeText(RegistrationActivity.this, "Enter Miniumum 6 Character Password", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if(imageUri!=null)
                                {
                                    ...
                                    String staus="Hey There I'm Using This Application";
                                    imageURI="https://firebasestorage.googleapis.com/v0/b/quickchatapp-2fdd7.appspot.com/o/Profile-ICon.png?alt=media&token=5f1c0957-7cee-4f56-b217-3d6aa90a7ff2";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,staus);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
